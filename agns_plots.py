...
props = {
    ...
    'log_tdep_log_Mass_gas_Av_gas_rad': dict(fname='logtdepHa_Mgas_Av_gas_rad', label=r'$\log$ ($\tau_{\rm dep}/{\rm Gyr})$', extent=[-3, 1], majloc=4, minloc=2),
    'log_tdep_SF_log_Mass_gas_Av_gas_rad': dict(fname='logtdepHaSF_Mgas_Av_gas_rad', label=r'$\log$ ($\tau_{\rm         dep}/{\rm Gyr})$', extent=[-3, 2], majloc=5, minloc=2),
    'log_tdep_ssp_log_Mass_gas_Av_gas_rad': dict(fname='logtdepssp_Mgas_Av_gas_rad', label=r'$\log$ ($\tau_{\rm dep}^\star/{\rm Gyr})$', extent=[-4, 1], majloc=5, minloc=2),
    'tdep_log_Mass_gas_Av_gas_rad': dict(fname='tdepHa_Mgas_Av_gas_rad', label=r'$\tau_{\rm dep}/{\rm Gyr}$', extent=[0, 30], majloc=5, minloc=2),
    'tdep_SF_log_Mass_gas_Av_gas_rad': dict(fname='tdepHaSF_Mgas_Av_gas_rad', label=r'$\tau_{\rm dep}/{\rm Gyr}$', extent=[0, 30], majloc=5, minloc=2),
    'tdep_ssp_log_Mass_gas_Av_gas_rad': dict(fname='tdepssp_Mgas_Av_gas_rad', label=r'$\tau_{\rm dep}^\star/{\rm Gyr}$', extent=[0, 30], majloc=5, minloc=2),
    ...
    'log_tdep_log_Mass_gas': dict(fname='logtdepHa_Mgas', label=r'$\log$ ($\tau_{\rm dep}/{\rm Gyr})$', extent=[-2.5, 1.5], majloc=4, minloc=2),
    'log_tdep_SF_log_Mass_gas': dict(fname='logtdepHaSF_Mgas', label=r'$\log$ ($\tau_{\rm dep}/{\rm Gyr})$', extent=[-1.2, 2.2], majloc=4, minloc=2),
    'log_tdep_ssp_log_Mass_gas': dict(fname='logtdepssp_Mgas', label=r'$\log$ ($\tau_{\rm dep}^\star/{\rm Gyr})$', extent=[-4, 1], majloc=5, minloc=2),
    'tdep_log_Mass_gas': dict(fname='tdepHa_Mgas', label=r'$\tau_{\rm dep}/{\rm Gyr}$', extent=[0, 30], majloc=5, minloc=2),
    'tdep_SF_log_Mass_gas': dict(fname='tdepHaSF_Mgas', label=r'$\tau_{\rm dep}/{\rm Gyr}$', extent=[0, 30], majloc=5, minloc=2),
    'tdep_ssp_log_Mass_gas': dict(fname='tdepssp_Mgas', label=r'$\tau_{\rm dep}^\star/{\rm Gyr}$', extent=[0, 30], majloc=5, minloc=2),
...
if __name__ == '__main__':
    ...
    y_key_list = [# 'SFE_log_Mass_gas_Av_gas_rad',
                  ...
                  # 'log_tdep_SF_log_Mass_gas_Av_gas_rad',
                  # 'log_tdep_ssp_log_Mass_gas_Av_gas_rad',
                  'log_fgas_log_Mass_gas_Av_gas_rad',
                  'SFE_log_Mass_gas',
                  'SFE_SF_log_Mass_gas',
                  'SFE_ssp_log_Mass_gas',
                  'tdep_log_Mass_gas',
                  'tdep_SF_log_Mass_gas',
                  'tdep_ssp_log_Mass_gas',
                  'log_tdep_log_Mass_gas',
                  'log_tdep_SF_log_Mass_gas',
                  'log_tdep_ssp_log_Mass_gas',
